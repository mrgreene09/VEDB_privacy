...
Face privacy script. Detects faces via mtcnn on 50% downsampled frames only
when YOLO has detected a body.
...
# parser.add_argument("-s", "--scale", help="Scale percentage")
