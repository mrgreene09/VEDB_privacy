...
outName = '/Users/abrahammieses/Desktop/newer_vid_folder/crowd3.mov'
...
def resize(frame):
    ...
    scale_percent = int(scale_percentage)  # percent of original size you want
...
while vid.isOpened():
    ...
    #image_prepare = prepare('/Users/abrahammieses/Desktop/video_folder/cats.mp4')

    # resize image here
    imaged_resized = resize(image)
